...
let heroSlider = document.querySelector('.hero__slider'),
    ...
    heroTrackWidth = heroSlider.offsetWidth,

    heroSlideLength = document.querySelectorAll('.hero__slide').length

heroIndex = 0;

heroSlider.style.transform = `translate3d(0px, 0px, 0px)`;

function nextSlide(e) {
    heroSlider.style.transform = `translate3d(-${e * heroTrackWidth}px, 0px, 0px)`;
}
